...
subtitle: "February 21st's Full Competitive Programming Experience"
...
Yesterday's competitive programming experience was definitely chaotic, hence why I have an old classic introduction image of Days of Our Programmers, a somewhat satrical introduction method I used in a few archive logs when preceeding some really unfortunate competitive programming implosions. If you want an idea of what said implosions look like, [November 2022's Archive Log (currently being setup, not up yet)](https://alxwen711.github.io/HonestCode/posts/archive/2022-11/#november-16st-30th) will be an example of what such implosions can look like. The good news is that it'll be apparent that there wasn't a massive underachievement in any of the contests recapped here. That said, it was such a hectic day of competitive programming that I find it is deserving for one of the rare public episodes of Days of Our Programmers.
:::

To properly understand the importance of each of these contests we need some context. First up is the CodeForces competition. In the short term this is the most important of the competitions as there are only so many of these competitions I can do since they basically have to either be on the weekend, or I have to be at UBC by 6:30AM in the cases where I want to do these contests and attend classes. Further more, we have my CodeForces history via CLIST since November:

![The downfall of my CF rating.](cfoof.png)

Yes, rating is not everything, but dropping 254 ELO over the course of 6 contests is not exactly good. Screwing up here means that unless I decide to go to UBC early Monday morning, the next chance I will have to get back to 1900 ELO will be **March 16th**. I'd much rather not wait that long. Then there is our team's weekly ICPC practice, since as part of Diamond Dust ([the UBC ICPC team](https://icpc.cs.ubc.ca/team)), I will be in the ICPC North American Championship March 18th to 23rd. Usually this means for weekly practice we do [UCUP](https://contest.ucup.ac/contests) on a weekly basis, but in this case there is a slight adjustment as we are doing a mock run of the 2026 ICPC Europe Championship. This should give us a decent idea of where our team is at one month before the main event. Lastly, there is also Leetcode's weekly competition. While I consider this my 4th site for online competitive programming practice (behind CodeForces, AtCoder, and CodeChef in that order) due to the more technical interview type problems and overall contest structure being less than ideal (4 questions in 90 minutes, of which solving all four happens for up to a few thousand coders on a regular basis, making these contests boil down to speed a lot of the time), it's still good competitive programming practice. Plus, I want to turn around my 2025 results on Leetcode, which have been not great to say the least.

![Started 2612 ELO, ended at 2430 ELO. Leetcode ratings also tend to be more rigid than CodeForces.](leetoof.png)

So it suffices that the competitions are all quite critical. Adding to that as some sort of omen was the night before, CodeForces got hacked.
