...
At this point of the contest I was just rushing as fast as I could.

- We're rushing through this now
- Only need to find a solution, AND it exists
- working out case got `7 7 7 1 0`, general idea works kinda
- Worst case initial estimate was $O(n^2)$ due to each index possibly contributing
- "Only bits could be involved in this??"
- Each addition contributing 1 bit resolves this to $O(n \log A)$
- Not sure how each addition only added bits and there was no weird interchanging
