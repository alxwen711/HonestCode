...
This is a joint award between [CodeForces Round 858](https://codeforces.com/contest/1806) and [Educational CodeForces Round 145](https://codeforces.com/contest/1809). It just happens that both of these contests together provide both the insane highs and lows of competitive programming ability from me. Once the [March 2023](https://alxwen711.github.io/HonestCode/posts/archive/2023-03/) archive post is up, it will explain why. This also happened the after [February 2023](https://alxwen711.github.io/HonestCode/posts/archive/2023-02/) in which my first Division 1 ICPC competition occurred (the previous was Division 2), so to bottom out to practically an all time low and then reach a high I quite literally have never matched since makes this pair very deserving.

### 2024

[Round 975 (Div. 1)](https://codeforces.com/contest/2018) was not just a well designed competition, but also the main contest I go to when showing that rating does not mean everything. To this day, this is the only solo Division 1 contest I have solved at least 3 problems. The actuality is that I solved 4 problems, and even if they were somewhat easier in rating (B was 1900 and C was 1700), [Problem D](https://codeforces.com/contest/2018/problem/D) was a 2200 rated problem, which is well in the upper range of difficulty of what I've even solved.

![Bar graph of every contest problem I've solved in CodeForces.](probdiff.png)
